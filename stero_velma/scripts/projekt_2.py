...
if __name__ == "__main__":
    ...
    def grabHandle(dist_ang,dist_hor,dist_ver):
        ...
        if ldYaw + dist_ang >= cabYaw + math.pi/2 :
    ...
    velma.moveCartImpRight([dest_cab], [4.0], None ,None , [makeWrench(50,50,1000,100,100,100)], [1], PyKDL.Wrench(PyKDL.Vector(5,5,5), PyKDL.Vector(5,5,5)), start_time=0.5)
